...
function test_scripts() {
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'test-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );
	}
}
...
/* ==========================================================================
   FFPUNDITS Additional functions
   ========================================================================== */

/**
 * Lets load jQuery and add it to the header
 */
...
/**
 * Lets then load modernizr and also add it to the header
 */
...
function add_my_scripts() {
  ...
  wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/modernizr.js', array(), '2.5.2', false ); 
}
